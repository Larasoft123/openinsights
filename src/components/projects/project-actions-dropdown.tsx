...
export function ProjectActionsDropdown({
  ...
  const buttonClass =
    variant === 'card'
      ? 'absolute top-4 right-4 z-10 rounded-lg p-2 text-foreground/70 transition-all hover:bg-black/30 hover:text-foreground opacity-0 group-hover:opacity-100'
