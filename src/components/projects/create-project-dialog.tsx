  ...
  return createPortal(
    <>
      ...
      <div className="fixed top-1/2 left-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 px-4">
        <div className="max-h-[90vh] overflow-hidden rounded-2xl border border-borde bg-background shadow-2xl">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="max-h-[calc(90vh-80px)] overflow-y-auto p-6">
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="focus:border-accent-primary w-full rounded-lg border border-border bg-background px-4 py-2.5 text-foreground placeholder-gray-500 transition-colors outline-none"
                />
              </div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                ...
                className="bg-accent-primary hover:bg-accent-primary/90 flex-1 rounded-lg px-4 py-2.5 text-sm font-medium text-foreground transition-colors disabled:cursor-not-allowed disabled:opacity-50"
              >
